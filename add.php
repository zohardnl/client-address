...
if( isset( $_POST['add'] ) ) {
    ...
    if( $clientName && $clientEmail ) {
        ...
        // create query
        $query = "INSERT INTO clients2 (id, user, name, email, phone, address, company, notes, date_added) VALUES (NULL, '$user2' ,'$clientName', '$clientEmail', '$clientPhone', '$clientAddress', '$clientCompany', '$clientNotes', CURRENT_TIMESTAMP)";
