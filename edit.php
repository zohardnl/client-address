...
$query = "SELECT * FROM clients2 WHERE id='$clientID'";
...
if( isset($_POST['confirm-delete']) ) {
    ...
    // new database query & result
    $query = "DELETE FROM clients2 WHERE id='$clientID'";
    $result = mysqli_query( $conn, $query );
