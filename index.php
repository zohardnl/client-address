...
if( isset( $_POST['login'] ) ) {
    ...
    // create query
    $query = "SELECT `name`,`password`,`user` FROM users2 WHERE email='$formEmail'";
...
// check for query string
    if( isset( $_GET['signup'] ) ) {
        ...
        if( $_GET['signup'] == 'success' ) {
            $alertMessage = "<div class='alert alert-success'>Your sign up success , now you can sign in! <a class='close' data-dismiss='alert'>&times;</a></div>";
    }
}
